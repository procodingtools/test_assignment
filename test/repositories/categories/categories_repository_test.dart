...
Future<void> main() async {
  ...
  setUp(() {
    ...
    repository = CategoryRepository(service: service);
  });
...
function clearCanvas() {
  ...
  group('Testing Categories service', () { 
    test('Testing getCategories', () async {
      dioAdapter.onGet('other/cocoexplorer.js', (server) => server.reply(200, jsFile));
      final response = await repository.getCategories();
      expect(response, isA<List<CategoryModel>>());
